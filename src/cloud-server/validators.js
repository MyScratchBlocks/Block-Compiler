...
const VARIABLE_NAME_MAX_LENGTH = 2000;

/** The maximum length of a variable's value. Increased since some people actually use long cloud servers in a creative way.  */
const VALUE_MAX_LENGTH = 10000000000000;
